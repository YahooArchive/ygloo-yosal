#ifndef _YOSAL_DIGEST_MD5_H
#define _YOSAL_DIGEST_MD5_H
...
#define MD5Init YPRIVATE(MD5Init)
#define MD5Update YPRIVATE(MD5Update)
#define MD5Final YPRIVATE(MD5Final)
