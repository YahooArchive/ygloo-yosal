...
base64_decode_value(char value_in)
{
  ...
  static const unsigned char decoding_size = sizeof(decoding);
  value_in -= 43;
                        ...
                        char* plaintext_out, base64_decodestate* state_in)
{
  ...
  unsigned char* plainchar = (unsigned char*) plaintext_out;
  unsigned char* plainchar_base = plainchar;
    ...
    case step_a:
      do {
        if (codechar == code_in+length_in) {
          ...
          return plainchar - plainchar_base;
        }
